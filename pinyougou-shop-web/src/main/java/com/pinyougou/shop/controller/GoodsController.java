...
public class GoodsController {
	 ...
	 */
	@RequestMapping("/add")
	public ResultVO add(@RequestBody TbGoods goods){
		try {
	...
	public ResultVO update(@RequestBody TbGoods goods){
		try {
	...
	public PageVO search(@RequestBody TbGoods goods, int page, int rows  ){
