...
public class TypeTemplateController {
	 ...
	 */
	@RequestMapping("/add")
	public ResultVO add(@RequestBody TbTypeTemplate typeTemplate){
		try {
	...
	public ResultVO update(@RequestBody TbTypeTemplate typeTemplate){
		try {
	...
	public PageVO search(@RequestBody TbTypeTemplate typeTemplate, int page, int rows  ){
